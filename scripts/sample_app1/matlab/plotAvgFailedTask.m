function [] = plotAvgFailedTask()
    ...
    plotGenericResult(1, 2, 'Failed Tasks (%)', 'ALL_APPS', 'percentage_for_failed');
    plotGenericResult(1, 2, {'Failed Tasks for';'Augmented Reality App (%)'}, 'USER_DWELL', 'percentage_for_failed');
